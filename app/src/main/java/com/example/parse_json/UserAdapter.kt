...
import com.example.parse_json.data.ResultUsers

class UserAdapterclass UsersAdapter(val data: List<ResultUsers>?) : RecyclerView.Adapter<UsersAdapter.MyHolder>() {
